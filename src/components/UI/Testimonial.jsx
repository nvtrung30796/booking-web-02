    ...
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Trung Nguyen</h6>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">Henry</h6>
            <p className="section__description">Customer</p>
          </div>
        </div>
      </div>
      ...
      <div className="testimonial py-4 px-3">
        <p className="section__description">
        Excellent customer service. I worked with Mrs Lee and she was so polite and nice to work with. Definitely knows her business. Will continue to use this company
        </p>
        ...
        <div className="mt-3 d-flex align-items-center gap-4">
          ...
          <div>
            <h6 className="mb-0 mt-3">David</h6>
            <p className="section__description">Customer</p>
          </div>
        </div>
      </div>
